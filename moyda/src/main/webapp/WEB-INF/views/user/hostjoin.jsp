...
<style>
	...
	#wrap::after {
    	...
    	height: 100%;
     	content: "";
		background: url("./img/hostroot.jpg");
...
<body  id="wrap">
	<div>
		<form id="joinForm" action="/www/hostjoin" method="post" enctype="multipart/form-data">
			...
			<div>
				...
				<span id="license_msg"></span>
				<div class="form-group">
					<input type="text" class="form-control" id="license" name="license"value='필수입력 사항입니다'  onfocus="this.value='';this.style.color='black';">
				</div>
			</div>
			<div>
