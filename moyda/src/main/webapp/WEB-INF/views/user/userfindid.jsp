...
$(function(){
	...
	$("#findid","#findpass").on("click",function(){
		$("#joinForm").submit();
	});
});
...
<form id="joinForm" action="/www/userfindid" method="post">
         ...
         <table width="800px" height="300px" align="center"nstyle="border: dotted 5px none; margin-top: 4%">
          ...
          <tr>
           ...
           <table width="380px" height="70px" align="center" border="0" style="font-size: 16px;">
            ...
            <tr>
             ...
             <td><input type="text" name="email" style="width: 80px"> @ <input type="text" name="e_domain" style="width: 80px"> 
          ...
          <tr>
           <td>
            <table width="140px" height="10px" border="0" style="margin-top: 2%" align="center">
             <tr>
             <td><button id="findpass" name="enter2" align="center" style="cursor: pointer; background: white; color: black; border-color: black;">&nbsp;&nbsp;찾기&nbsp;&nbsp;</button></td>
             </tr>
            </table>
            <br>
           </td>
